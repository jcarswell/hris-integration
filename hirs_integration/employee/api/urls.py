...
router_s2.register(r'phone_number', views.S2EmployeePhoneView)
router_s2.register(r'address', views.S2EmployeeAddressView)
router_s2.register(r'employee', views.S2EmployeeView)
router_s2.register(r'source', views.S2EmployeeImportView)

router.register(r'phone_number', views.EmployeePhoneView)
router.register(r'address', views.EmployeeAddressView)
